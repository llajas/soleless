...
def generate_auth_url(client_id, redirect_uri, state):
    ...
    response_type = "code"
    scope = "all"
    auth_url = f"{base_url}?client_id={client_id}&response_type={response_type}&scope={scope}&redirect_uri={quote_plus(redirect_uri)}&state={state}"
    return auth_url
...
if __name__ == "__main__":
    ...
    state = 'your_unique_csrf_token_here'
